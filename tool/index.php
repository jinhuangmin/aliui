...
<head>
<meta charset="utf-8">
<title>沃姆设计 阿里巴巴国际站2.0装修辅助工具</title>
...
#phoneToolInput .pti-label{
	font-size:12px;
	color:#444444;
}

#phoneToolInput .pti-content  .pageinput {
    width: 55px;
    height: 20px;
    font-size: 12px;
    color: #525c66;
    background: #fff;
    border: 1px #c2cbcc solid;
    border-shadow: 0;
    text-indent: 2px;
    outline: none;
}
#phoneToolInput .pti-content  .bginput {
    width: 150px;
    height: 20px;
    font-size: 12px;
    color: #525c66;
...
#phoneToolInput .pti-content  .px{
	   background-image: url(https://img.alicdn.com/imgextra/i4/800803731/TB2BWwEfthvOuFjSZFBXXcZgFXa_!!800803731.png);
    background-position: -440px -434px;
}
#phoneToolInput  .pti-content{
	display: inline-block;
	position:relative;
}
#mouseaction{display: inline-block;position:relative;}
#mouseaction .hrq{
	width:96px;
	height:39px;
	display: inline-block;
	background: url("https://img.alicdn.com/imgextra/i2/800803731/TB2lPcFuuGSBuNjSspbXXciipXa-800803731.jpg")no-repeat center center;
	cursor:pointer;
	position: absolute;
    top: -25px;
    left: 20px;
...
<body style="overflow:hidden;">
	<div id="header">
	    <div class="head">
	        <div class="logo">
	            <a href="javascript:;">
	                <img src="https://img.alicdn.com/imgextra/i2/800803731/TB2I0nIuuGSBuNjSspbXXciipXa-800803731.jpg"></a>
	        </div>
	        <div class="j_nav_left cf">
	        	<p class="tit">外贸模板装修工具1.0</p>
	        	<a class="ww june-preview" href="http://amos.alicdn.com/msg.aw?v=2&amp;uid=cn1522562293knox&amp;site=enaliint&amp;s=24&amp;charset=UTF-8" target="_blank">国际站旺旺<img style="vertical-align:middle;margin-left:5px;" src="https://img.alicdn.com/imgextra/i4/800803731/TB2ZfApmC8YBeNkSnb4XXaevFXa-800803731.png"></a>

	        	<a class="ww june-preview" target="_blank" href="http://www.taobao.com/webww/ww.php?ver=3&touid=%E6%B2%83%E5%A7%86%E8%AE%BE%E8%AE%A1&siteid=cntaobao&status=1&charset=utf-8">淘宝旺旺<img style="vertical-align:middle;margin-left:5px;" src="https://img.alicdn.com/imgextra/i4/800803731/TB2ZfApmC8YBeNkSnb4XXaevFXa-800803731.png"></a>
	        	<div class="tel">定制设计: 15355003615</div>
	        	<div class="tel">售后服务：18072803854</div>
	        </div>
	        <div class="j_nav_right cf">
	        	<a class="nav_1 june-preview" target="_blank" href="http://www.cnzoom.com/doc/qprq">操作教程</a>
	        	<a class="nav_1 june-preview" target="_blank" href="https://zhuangxiu.alibaba.com/list.html?market=icbuzx&_input_charset=GBK&key=%E6%B2%83%E5%A7%86">订购外贸模板</a>
	        	<a class="nav_1 june-preview" target="_blank" href="http://www.cnzoom.com/en/case/">外贸设计案例</a>
	        </div>
	    </div>
	</div>
	<div id="hd" >
		<div id="help_nav">
			<span>第<b>1</b>步</span>
			<div id="phoneToolInput" style="margin-right:40px">
				<span class="pti-label" >模块宽度</span>
				<div class="pti-content" >
					<input class="pageinput px" type="text" id="ptiModuleWidth" name="ptiModuleWidth" value="" class="textinput"/>
				</div>
				<span class="pti-label" >图片地址</span>
				<div class="pti-content c-ptiModuleBg">
					<input id="jModuleBg" class="bginput" type="text" name="ptiModuleBg1" value="" autocomplete="off" class="textinput" placeholder="支持Gif图片"/>
				</div>
			</div> 
			<span>第<b>2</b>步</span>
			<div id="mouseaction">
				<div class="hrq"   data-target="selected" data-curtype="draw"></div>
			</div> 
			<span style="margin-left:160px">第<b>3</b>步</span>
			<div id="mouseaction">
				<div id="makecode" data-target="coded" data-codeType="codeExport"></div>
			</div>
			<div id="topbanner">
				<span class="pti-label" >维护更新</span>
				<div id="importcode" data-target="coded" data-codeType="codeImport" style="right:40px;"></div>
			</div>
		...
		<div id="topbanner" style="display:none">
			...
			<div id="kbhelp" style="right:380px;display:none" ></div>
			<div id="xifuconfig" style="right:230px;display:none"></div>
	...
	<div id="leftpannel" style="display:none">
		<div id="btngroup">
			<div id="applist" style="display:none;">
			</div>
			<!-- <div id="phoneToolInput">
				<div class="pti-header" style="display:none">
					<h3>背景图片设置</h3>
				</div>
				<div class="pti-label" >模块宽度</div>
				<div class="pti-content" >
					<input type="text" id="ptiModuleWidth" name="ptiModuleWidth" value="" class="textinput"/>
				</div>
				...
				<div class="pti-label ptiImgName">
					<span class="pti-img-name">背景图片设置</span>
	...
	<div id="leftconsole" style="background: #101519;display:none;">
	...
	<div id="bd">
		<div id="box">
			<div id="junebox" data-ptType="rq" style="overflow:auto;position:absolute;left:50px;top:50px;overflow:auto;">
				<div id="june" style="width:1920px;height:2560px;position:absolute;left:0;top:0;background:url(http://img01.taobaocdn.com/imgextra/i1/39767794/TB28I_vbXXXXXaMXXXXXXXXXXXX-39767794.png) #ffffff no-repeat 0% 0%;"></div>
	...
	<div id="phoneToolRightPanel" class="phoneToolRightPanel">
		...
		<p style="display:none;">输入手机端链接 <a class="june-preview" target="_blank" href="http://www.cnzoom.com/gm" style="color:#f00;">手机端链接转换工具</a></p>
		<ul class="ptrp-ul">
			...
			<li class="ptrp-li1">
				<label class="ptrp-label">弹图地址：</label>
				<input id="ptrpIHrefX" class="ptrp-input" type="text" title="" autocomplete="off" name="ptrpIHrefX" value="" />
			</li>
		</ul>
	</div>
...
<script type="text/javascript">
 ...
 $(document).ready(function(){
 	var hbw=$(window).width()-50;
 	var hbh=$(window).height()-170;
 	$('#junebox').width(hbw).height(hbh);
   $('#ptiModuleWidth').on('input propertychange', function() {
   	if($("#ptiModuleWidth").val()){
   		 $("#june").width($("#ptiModuleWidth").val());
   	}else{
   		$("#june").width('1920');
   	}
   })
